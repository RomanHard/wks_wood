...
class Th_MiniCart extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mini Cart', 'decofurniture' );
	}
	...
	public function mini_cart() {
		...
		if ( ! \WC()->cart->is_empty() ) : ?>
		    ...
		    <div class="mini-cart-footer">
			    <div class="mini-cart-total clearfix">
			        <span class="pull-left"><?php esc_html_e( 'TOTAL', 'decofurniture' ); ?></span>
		...
		<?php else : ?>
		    ...
		    <div class="mini-cart-empty"><?php esc_html_e( 'No products in the cart.', 'decofurniture' ); ?></div>
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-cart-icon'		=> esc_html__( 'Icon', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'style_content',
			[
				'label' 	=> esc_html__( 'Content Style', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'elth-mini-cart-dropdown',
				'options'   => [
					'elth-mini-cart-dropdown'		=> esc_html__( 'Icon', 'decofurniture' ),
					'elth-mini-cart-side'		=> esc_html__( 'Side', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'show_price',
			[
				'label' => esc_html__( 'Show price', 'decofurniture' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_responsive_control(
			'size_number',
			[
				'label' => esc_html__( 'Size number', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			'color_number',
			[
				'label' => esc_html__( 'Color number', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'pos_left_number',
			[
				'label' => esc_html__( 'Position left', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' , '%'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'pos_top_number',
			[
				'label' => esc_html__( 'Position top', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' , '%'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown/side', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Typography', 'decofurniture' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Footer side', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style_content' => 'elth-mini-cart-side',
				]
		...
		$this->add_control(
			'footer_text_color',
			[
				'label' => esc_html__( 'Text Color', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'footer_text_space',
			[
				'label' => esc_html__( 'Space text', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		if(class_exists("woocommerce")){
			...
			<div class="elth-mini-cart <?php echo esc_attr($settings['style'].' '.$settings['style_content'])?>">			
	            ...
	            <div class="mini-cart-content">
	            	<?php 
	            	$h_title = esc_html__('item','decofurniture');
