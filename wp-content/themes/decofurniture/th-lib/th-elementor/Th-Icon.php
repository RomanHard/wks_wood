...
class Th_Icon extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Icon Box', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
            'icon_box',
            [
                'label' => esc_html__( 'Icon Box', 'decofurniture' ),
            ]
        );

        $this->add_control(
            'icon_type', [
                'label'       => esc_html__( 'Icon Type', 'decofurniture' ),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'decofurniture' ),
                        'icon'  => 'la la-paint-brush',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'decofurniture' ),
                        'icon'  => 'la la-image',
                    ],
                ],
                'default'       => 'icon',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'This is the heading', 'decofurniture' ),
                'placeholder' => esc_html__( 'Enter your title', 'decofurniture' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit  to change this text.', 'decofurniture' ),
                'placeholder' => esc_html__( 'Enter your description', 'decofurniture' ),
                'separator' => 'none',
                'rows' => 10,
                'show_label' => false,
            ]
        ...
        $this->start_controls_section(
			'section_social',
			[
				'label' => esc_html__( 'Socials', 'decofurniture' ),
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					''		=> esc_html__( 'Default', 'decofurniture' ),
					'style1'		=> esc_html__( 'Style1', 'decofurniture' ),
				],
				'condition' => [
					'check_social' => 'yes',
				]
		...
		$repeater_social->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Enter title' , 'decofurniture' ),
				'label_block' => true,
			]
		);
		$repeater_social->add_control(
		...
		$this->add_control(
			'list_social',
			[
				'label' => esc_html__( 'Add socials', 'decofurniture' ),
        ...
        $this->start_controls_section(
			'section_style_image',
			[
				'label' => esc_html__( 'Icon/Image', 'decofurniture' ),
		...
		$this->add_control(
			'icon_color_hover',
			[
				'label' => esc_html__( 'Color hover', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_style_box',
			[
				'label' => esc_html__( 'Box', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Box hover', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Social', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'check_social' => 'yes',
				]
		...
		$this->add_responsive_control(
			'social_padding_wrap',
			[
				'label' => esc_html__( 'Wrap Padding', 'decofurniture' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'separator' => 'before',
				'selectors' => [
		...
		$this->add_responsive_control(
			'social_margin_wrap',
			[
				'label' => esc_html__( 'Wrap Margin', 'decofurniture' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
