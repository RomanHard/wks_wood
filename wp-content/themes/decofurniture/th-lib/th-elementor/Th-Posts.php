...
class Th_Posts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts', 'decofurniture' );
	}
	...
	public function get_thumb_default_animation($key='thumb_default_animation', $class="") {
		$this->add_control(
			$key,
			[
				'label' 	=> esc_html__( 'Thumbnail default animation', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'description' => esc_html__( 'Item style apply for Grid or Slider', 'decofurniture' ),
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Style 1 - default', 'decofurniture' ),
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-post-grid'			=> esc_html__( 'Grid', 'decofurniture' ),
					'elth-post-slider'			=> esc_html__( 'Slider', 'decofurniture' ),
					'elth-post-grid-layout1'	=> esc_html__( 'Grid - layout 1', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'type_active',
			[
				'label' 	=> esc_html__( 'Active type', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'grid',
				'options'   => [
		...
		$this->add_group_control(
			...
			[
				...
				'default' => 'large',
				'separator' => 'none',
				'description' => esc_html__( 'Apply for Grid  style active grid or Slider', 'decofurniture' ),
			]
		);
		...
		$this->add_control(
			'item_meta',
			[
				'label' => esc_html__( 'Meta data', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_meta_select',
			[
				'label' 	=> esc_html__( 'Meta', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT2,
				'default'   => '',
				'options'   => [
					'author'	=> esc_html__( 'Author', 'decofurniture' ),
					'date'		=> esc_html__( 'Date', 'decofurniture' ),
					'cats'		=> esc_html__( 'Categories', 'decofurniture' ),
					'tags'		=> esc_html__( 'Tags', 'decofurniture' ),
					'comments'	=> esc_html__( 'Comments', 'decofurniture' ),
					'views'		=> esc_html__( 'Total views', 'decofurniture' ),
				],
				'multiple'	=> true,
				'condition' => [
					'item_meta' => 'yes',
		...
		$this->add_control(
			'item_excerpt',
			[
				'label' => esc_html__( 'Excerpt', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_list',
			[
				'label' => esc_html__( 'List', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display' => 'elth-post-grid',
				]
		...
		$this->add_control(
			'item_list_style',
			[
				'label' 	=> esc_html__( 'Item list style', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Style 1 - default', 'decofurniture' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Thumbnail Width', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' , 'px' ],
				'range' => [
					'%' => [
		...
		$this->add_control(
			'excerpt_list',
			[
				'label' => esc_html__( 'Excerpt list', 'decofurniture' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 500,
				'step' => 1,
		...
		$this->start_controls_section(
			'section_top_filter',
			[
				'label' => esc_html__( 'Top filter', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display' => 'elth-post-grid',
				]
		...
		$this->add_control(
			'show_type',
			[
				'label' => esc_html__( 'Type', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'meta_space',
			[
				'label' => esc_html__( 'Space meta item', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_responsive_control(
			'meta_icon_space',
			[
				'label' => esc_html__( 'Space icon', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
