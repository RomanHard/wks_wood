...
class Th_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products', 'decofurniture' );
	}
	...
	public function get_thumb_styles($key='thumb', $class="thumb-image") {
		...
		$this->add_control(
			$key.'_overlay',
			[
				'label' => esc_html__( 'Overlay', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'zoom-thumb'		=> esc_html__( 'Zoom', 'decofurniture' ),
					'rotate-thumb'		=> esc_html__( 'Rotate', 'decofurniture' ),
					'zoomout-thumb'		=> esc_html__( 'Zoom Out', 'decofurniture'),
					'translate-thumb'	=> esc_html__( 'Translate', 'decofurniture'),
				],
			]
		);
	...
	public function get_slider_settings() {
		$this->start_controls_section(
			'section_slider',
			[
				'label' => esc_html__( 'Slider', 'decofurniture' ),
		...
		$this->add_responsive_control(
			'slider_items',
			[
				'label' => esc_html__( 'Items', 'decofurniture' ),
		...
		$this->add_responsive_control(
			'slider_space',
			[
				'label' => esc_html__( 'Space(px)', 'decofurniture' ),
				'description'	=> esc_html__( 'For example: 20', 'decofurniture' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 200,
				'step' => 1,
		...
		$this->add_control(
			'slider_column',
			[
				'label' => esc_html__( 'Columns', 'decofurniture' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 10,
				'step' => 1,
		...
		$this->add_control(
			'slider_speed',
			[
				'label' => esc_html__( 'Speed(ms)', 'decofurniture' ),
				'description'	=> esc_html__( 'For example: 3000 or 5000', 'decofurniture' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 3000,
				'max' => 10000,
				'step' => 100,
		...
		$this->add_control(
			'slider_auto',
			[
				'label' => esc_html__( 'Auto width', 'decofurniture' ),
		...
		$this->add_control(
			'slider_center',
			[
				'label' => esc_html__( 'Center', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_loop',
			[
				'label' => esc_html__( 'Loop', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_navigation',
			[
				'label' => esc_html__( 'Navigation', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'decofurniture' ),
				'label_off' => esc_html__( 'Hide', 'decofurniture' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'slider_pagination',
			[
				'label' => esc_html__( 'Pagination', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'decofurniture' ),
				'label_off' => esc_html__( 'Hide', 'decofurniture' ),
				'return_value' => 'yes',
	...
	public function get_box_settings($key='box-key',$class="box-class") {
		...
		$this->add_responsive_control(
			$key.'_padding_wrap',
			[
				'label' => esc_html__( 'Padding Column', 'decofurniture' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', ],
				'selectors' => [
	...
	public function get_slider_styles() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Navigation', 'decofurniture' ),
		...
		$this->add_control(
			'slider_icon_next',
			[
				'label' => esc_html__( 'Icon next', 'decofurniture' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
		...
		$this->add_control(
			'slider_icon_prev',
			[
				'label' => esc_html__( 'Icon prev', 'decofurniture' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Pagination', 'decofurniture' ),
				'tab' 	=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'display' => 'elth-product-slider',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'none',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Background', 'decofurniture' ),
				'description'	=> esc_html__( 'Active status', 'decofurniture' ),
				'types' => [ 'classic', 'gradient', 'video' ],
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => esc_html__( 'Layout', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'display',
			[
				'label' 	=> esc_html__( 'Display type (Layout)', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'elth-product-grid',
				'options'   => [
					'elth-product-grid'		=> esc_html__( 'Grid', 'decofurniture' ),
					'elth-product-slider'		=> esc_html__( 'Slider', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'item_style',
			[
				'label' 	=> esc_html__( 'Item style', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'style1',
				'options'   => [
					''		=> esc_html__( 'Style 1 - default', 'decofurniture' ),
		...
		$this->add_control(
			'display_tab',
			[
				'label' => esc_html__( 'Display tab', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_thumbnail',
			[
				'label' => esc_html__( 'Thumbnail', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_quickview',
			[
				'label' => esc_html__( 'Quick View', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_price',
			[
				'label' => esc_html__( 'Price', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'item_rate',
			[
				'label' => esc_html__( 'Rate', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_posts',
			[
				'label' => esc_html__( 'Query', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'number',
			[
				'label' => esc_html__( 'Number', 'decofurniture' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 1000,
				'step' => 1,
		...
		$this->add_control(
			'orderby',
			[
				'label' 	=> esc_html__( 'Order by', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'None', 'decofurniture' ),
					'ID'		=> esc_html__( 'ID', 'decofurniture' ),
					'author'	=> esc_html__( 'Author', 'decofurniture' ),
					'title'		=> esc_html__( 'Title', 'decofurniture' ),
					'name'		=> esc_html__( 'Name', 'decofurniture' ),
					'date'		=> esc_html__( 'Date', 'decofurniture' ),
					'modified'		=> esc_html__( 'Last Modified Date', 'decofurniture' ),
					'parent'		=> esc_html__( 'Parent', 'decofurniture' ),
					'post_views'		=> esc_html__( 'Post views', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'order',
			[
				'label' 	=> esc_html__( 'Order', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'DESC',
				'options'   => [
					'DESC'		=> esc_html__( 'DESC', 'decofurniture' ),
					'ASC'		=> esc_html__( 'ASC', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'product_type',
			[
				'label' 	=> esc_html__( 'Product type', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					'' 				=> esc_html__('Default','decofurniture'),
                    'trending' 		=> esc_html__('Trending','decofurniture'),
                    'featured' 		=> esc_html__('Featured Products','decofurniture'),
                    'bestsell' 		=> esc_html__('Best Sellers','decofurniture'),
                    'onsale' 		=> esc_html__('On Sale','decofurniture'),
                    'toprate' 		=> esc_html__('Top rate','decofurniture'),
                    'mostview' 		=> esc_html__('Most view','decofurniture'),
                    'menu_order' 	=> esc_html__('Menu order','decofurniture'),
				],
			]
		);
		...
		$this->add_control(
			'custom_ids', 
			[
				'label' => esc_html__( 'Show by IDs', 'decofurniture' ),
				'description' => esc_html__( 'Enter IDs list. The values separated by ",". Example 11,12', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( '11,12', 'decofurniture' ),
			]
		);
		...
		$this->add_control(
			'cats', 
			[
				'label' => esc_html__( 'Categories', 'decofurniture' ),
				'description' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2. Default will show all categories', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'decofurniture' ),
			]
		);
		...
		$this->start_controls_section(
			'section_grid',
			[
				'label' => esc_html__( 'Grid', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->add_responsive_control(
			'column',
			[
				'label' => esc_html__( 'Column', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'grid_type',
			[
				'label' 	=> esc_html__( 'Grid type', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''				=> esc_html__( 'Default', 'decofurniture' ),
					'grid-masonry'	=> esc_html__( 'Masonry', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'pagination',
			[
				'label' 	=> esc_html__( 'Grid pagination', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''				=> esc_html__( 'None', 'decofurniture' ),
					'pagination'	=> esc_html__( 'Pagination', 'decofurniture' ),
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Filter', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'filter_show',
			[
				'label' => esc_html__( 'Status', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'filter-col'		=> esc_html__( 'Style 2', 'decofurniture' ),
					'filter-col filter-col-list'	=> esc_html__( 'Style 3', 'decofurniture' ),
				],
				'condition' => [
					'filter_show' => 'yes',
				]
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'filter-2-col'				=> esc_html__( '2 Column', 'decofurniture' ),
					'filter-3-col'				=> esc_html__( '3 Column', 'decofurniture' ),
					'filter-4-col'				=> esc_html__( '4 Column', 'decofurniture' ),
				],
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Categories', 'decofurniture' ),
				'description' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'decofurniture' ),
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->add_control(
			'filter_attr', 
			[
				'label' => esc_html__( 'Attributes', 'decofurniture' ),
				'description' => esc_html__( 'Enter slug attributes. The values separated by ",". Example attribute-1,attribute-2', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'decofurniture' ),
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->start_controls_section(
			'section_tab',
			[
				'label' => esc_html__( 'Tab', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display_tab' => 'yes',
				]
		...
		$repeater->add_control(
			'title', [
				'label' => esc_html__( 'Title', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab Title' , 'decofurniture' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Add tab', 'decofurniture' ),
		...
		$this->start_controls_section(
			'section_style_item',
			[
				'label' => esc_html__( 'Item', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'decofurniture' ),
		...
		$this->add_control(
			'price_regular',
			[
				'label' => esc_html__( 'Regular', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			'price_sale',
			[
				'label' => esc_html__( 'Sale', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'tab_item_width',
			[
				'label' => esc_html__( 'Item width', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'tab_item_height',
			[
				'label' => esc_html__( 'Item height', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
