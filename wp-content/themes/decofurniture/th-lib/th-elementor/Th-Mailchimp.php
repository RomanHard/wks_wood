...
class Th_Mailchimp extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mailchimp', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-mailchimp-default'		=> esc_html__( 'Default', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'form_id',
			[
				'label' => esc_html__( 'Form ID', 'decofurniture' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Your email address', 'decofurniture' ),
		...
		$this->start_controls_section(
			'section_style_input',
			[
				'label' => esc_html__( 'Input', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
