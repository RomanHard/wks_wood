...
class Th_LogoText extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Logo Text', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Add Your Heading Text Here', 'decofurniture' ),
			]
		);
		...
		$this->add_control(
			'header_size',
			[
				'label' => esc_html__( 'HTML Tag', 'decofurniture' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'inline-block' => [
						'title' => esc_html__( 'Inline Block', 'decofurniture' ),
						'icon' => 'eicon-text-align-left',
					],
					'block' => [
						'title' => esc_html__( 'Block', 'decofurniture' ),
						'icon' => 'eicon-text-align-center',
					],
				],
		...
		$this->add_control(
			'view',
			[
				'label' => esc_html__( 'View', 'decofurniture' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Default', 'decofurniture' ),
					'stacked' => esc_html__( 'Stacked', 'decofurniture' ),
					'framed' => esc_html__( 'Framed', 'decofurniture' ),
				],
				'default' => 'default',
		...
		$this->add_control(
			'shape',
			[
				'label' => esc_html__( 'Shape', 'decofurniture' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => esc_html__( 'Circle', 'decofurniture' ),
					'square' => esc_html__( 'Square', 'decofurniture' ),
				],
				'default' => 'circle',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_control(
			'primary_color',
			[
				'label' => esc_html__( 'Primary Color', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'secondary_color',
			[
				'label' => esc_html__( 'Secondary Color', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'view!' => 'default',
		...
		$this->add_responsive_control(
			'rotate',
			[
				'label' => esc_html__( 'Rotate', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'default' => [
					'size' => 0,
		...
		$this->add_control(
			'border_width',
			[
				'label' => esc_html__( 'Border Width', 'decofurniture' ),
				'type' => Controls_Manager::DIMENSIONS,
				'selectors' => [
