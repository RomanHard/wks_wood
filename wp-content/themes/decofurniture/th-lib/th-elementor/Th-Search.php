...
class Th_Search extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Search form', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-search-default'		=> esc_html__( 'Default', 'decofurniture' ),
					'elth-search-icon'  		=> esc_html__( 'Icon', 'decofurniture' ),
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Search button', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'section_form',
			[
				'label' => esc_html__( 'Form', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'placeholder',
			[
				'label' => esc_html__( 'Placeholder', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Enter key to search', 'decofurniture' ),
				'placeholder' => esc_html__( 'Type your placeholder here', 'decofurniture' ),
			]
		);
		$this->add_control(
			'search_in',
			[
				'label'		=> esc_html__( 'Search in', 'decofurniture' ),
				'type' 		=> Controls_Manager::SELECT,
				'default' 	=> 'product',
				'options'   => [
					'product'  => esc_html__( 'Product', 'decofurniture' ),
					'post'     => esc_html__( 'Post', 'decofurniture' ),
					'all'      => esc_html__( 'All', 'decofurniture' ),
				],
			]
		);
		$this->add_control(
			'show_cat',
			[
				'label' => esc_html__( 'Show choose category', 'decofurniture' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2. Default will show all categories', 'decofurniture' ),
				'condition' => [
					'show_cat' => 'yes'
				]
			]
		...
		$this->add_control(
			'live_search',
			[
				'label' => esc_html__( 'Live search', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->start_controls_section(
			'section_icon_popup',
			[
				'label' => esc_html__( 'Icon - popup', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'section_style_cat',
			[
				'label' => esc_html__( 'Categories dropdown', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'All categories', 'decofurniture' ),
				'placeholder' => esc_html__( 'Type your title here', 'decofurniture' ),
			]
		);
		...
		$this->add_control(
			'title_cat_color',
			[
				'label' => esc_html__( 'Title Color', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background popup', 'decofurniture' ),
			...
			<div class="elth-search-form-wrap">
				...
				<form class="elth-search-form <?php echo esc_attr($settings['align_form'])?>" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			        ...
			        <div class="elth-list-product-search th-scrollbar">
			            <p class="text-center"><?php esc_html_e("Please enter key search to display results.","decofurniture")?></p>
			        </div>
			    </form>
			</div>
		</div>
