...
class Th_Instagram extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Instagram', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-instagram-grid'		=> esc_html__( 'Grid', 'decofurniture' ),
					'elth-instagram-slider'	=> esc_html__( 'Slider', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'media_from',
			[
				'label' 	=> esc_html__( 'Media from', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'username',
				'options'   => [
					'username'		=> esc_html__( 'Username', 'decofurniture' ),
					'media-lib'		=> esc_html__( 'Media library', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'username', 
			[
				'label' => esc_html__( 'User name', 'decofurniture' ),
		...
		$this->add_control(
			'token', 
			[
				'label' => esc_html__( 'Token', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			'number',
			[
				'label' => esc_html__( 'Photos number', 'decofurniture' ),
		...
		$this->add_control(
			'photos_size',
			[
				'label' 	=> esc_html__( 'Image size', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
					'0'		=> esc_html__( 'Small', 'decofurniture' ),
					'1'		=> esc_html__( 'Medium', 'decofurniture' ),
					'2'		=> esc_html__( 'Large', 'decofurniture' ),
				],
				'condition' => [
					'media_from' => 'username',
				]
		...
		$this->add_control(
			'text_hover', 
			[
				'label' => esc_html__( 'Text hover', 'decofurniture' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'title_field' => esc_html__( 'Item', 'decofurniture' ),
				'condition' => [
		...
		$this->add_control(
			'color_icon',
			[
				'label' => esc_html__( 'Color icon', 'decofurniture' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography text hover', 'decofurniture' ),
		...
		$this->add_responsive_control(
			'padding_wrap_item',
			[
				'label' => esc_html__( 'Padding wrap', 'decofurniture' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
