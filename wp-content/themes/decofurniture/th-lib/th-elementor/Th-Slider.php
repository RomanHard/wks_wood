...
class Th_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider', 'decofurniture' );
	}
	...
	public function get_slider_settings() {
		...
		$this->add_control(
			'slider_middle',
			[
				'label' => esc_html__( 'Middle', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_mousewheel',
			[
				'label' => esc_html__( 'Mousewheel', 'decofurniture' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'decofurniture' ),
				'label_off' => esc_html__( 'Off', 'decofurniture' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'slider_effects',
			[
				'label' 	=> esc_html__( 'Effects', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'decofurniture' ),
					'fade'			=> esc_html__( 'Fade', 'decofurniture' ),
					'coverflow'		=> esc_html__( 'Coverflow', 'decofurniture' ),
					'flip'			=> esc_html__( 'Flip', 'decofurniture' ),
					'cube'			=> esc_html__( 'cube', 'decofurniture' ),
				],
			]
		);
	...
	public function get_slider_styles() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''  => esc_html__( 'Default', 'decofurniture' ),
					'slider-nav-style2'  => esc_html__( 'Style 2', 'decofurniture' ),
					'slider-nav-style3'  => esc_html__( 'Style 3', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''  => esc_html__( 'Default', 'decofurniture' ),
					'slider-pag-style2'  => esc_html__( 'Style 2', 'decofurniture' ),
					'slider-pag-style3'  => esc_html__( 'Style 3', 'decofurniture' ),
					'slider-pag-style4'  => esc_html__( 'Style 4', 'decofurniture' ),
				],
			]
		);
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					''		=> esc_html__( 'Default', 'decofurniture' ),
					'megacontent'		=> esc_html__( 'Mega content', 'decofurniture' ),
				],
			]
		);
		...
		$repeater_sliders->add_control(
			...
			[
				...
				'rows' => 10,
				'default' => '',
				'placeholder' => esc_html__( 'Type your content here', 'decofurniture' ),
			]
		);
		...
		$repeater_sliders->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => "",
				'placeholder' => esc_html__( 'Enter text' , 'decofurniture' ),
				'label_block' => true,
			]
		);
		$repeater_sliders->add_control(
			'button_style',
			[
				'label' 	=> esc_html__( 'Button Style', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'decofurniture' ),
		...
		$repeater_sliders->add_control(
			...
			[
				'label' => esc_html__( 'Overlay background', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'list_sliders',
			[
				'label' => esc_html__( 'Add slide item', 'decofurniture' ),
		...
		$repeater_contents->add_control(
			'megapage',
			[
				'label' => esc_html__( 'Choose content', 'decofurniture' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
		...
		$this->add_control(
			'list_items',
			[
				'label' => esc_html__( 'Add mega item', 'decofurniture' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater_sliders->get_controls(),
				'title_field' => esc_html__( 'Page ID: {{{megapage}}}', 'decofurniture' ),
				'condition' => [
					'style' => 'megacontent',
				]
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider box', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content text', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style!' => 'megacontent',
				]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content box', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style!' => 'megacontent',
				]
		...
		$this->start_controls_section(
			'section_style_box',
			[
				'label' => esc_html__( 'Box item', 'decofurniture' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
