...
class Th_Popup extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Popup', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'onload',
				'options'   => [
					'onload'		=> esc_html__( 'On Load', 'decofurniture' ),
					'clickid'	=> esc_html__( 'Click', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'id_show', 
			[
				'label' => esc_html__( 'ID open', 'decofurniture' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Popup box', 'decofurniture' ),
