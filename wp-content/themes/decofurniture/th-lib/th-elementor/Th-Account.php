...
class Th_Account extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Account manager', 'decofurniture' );
	}
	...
	public function login_form($redirect_to = '') {
        ...
        <div class="elth-login-form popup-form active">
            <div class="form-header">
                <h2><?php esc_html_e( 'Log In','decofurniture' ); ?></h2>
                <div class="desc"><?php esc_html_e( 'Become a part of our community!','decofurniture' ); ?></div>
                <div class="message ms-done ms-default"><?php esc_html_e( 'Registration complete. Please check your email.','decofurniture' ); ?></div>
            </div>
            <form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
                <?php do_action( 'woocommerce_login_form_start' ); ?>
                <div class="form-field">
                    <input placeholder="<?php esc_html_e( 'Username or Email Address','decofurniture' ); ?>" type="text" name="log" id="user_login" class="input" size="20" autocomplete="off"/>
                </div>
                <div class="form-field">
                	<input placeholder="<?php esc_html_e( 'Password','decofurniture' ); ?>" type="password" name="pwd" id="user_pass" class="input" value="" size="20" autocomplete="off"/>
                </div>
                ...
                <div class="forgetmenot">
                    ...
                    <label class="rememberme" for="remembermep"><?php esc_html_e( 'Remember Me','decofurniture' ); ?></label>
                </div>
                <div class="submit">
                    <input type="submit" name="wp-submit" class="elth-bt-default elth-bt-full" value="<?php esc_attr_e('Log In','decofurniture'); ?>" />
            ...
            <div class="nav-form">
                <?php if ( get_option( 'users_can_register' ) ) :
                    echo '<a href="#registerform" class="popup-redirect register-link">'.esc_html__("Register","decofurniture").'</a>';
                endif;
                echo '<a href="#lostpasswordform" class="popup-redirect lostpass-link">'.esc_html__("Lost your password?","decofurniture").'</a>';
                ?>
            </div>
        </div>
        <?php
	...
	public function register_form($redirect_to = '') {
        ...
        <div class="elth-register-form popup-form">
            <div class="form-header">
                <h2><?php esc_html_e( 'Create an account','decofurniture' ); ?></h2>
                <div class="desc"><?php esc_html_e( 'Welcome! Register for an account','decofurniture' ); ?></div>
                <div class="message login_error error_1 ms-error ms-default"><?php esc_html_e( 'The user name or email address is not correct.','decofurniture' ); ?></div>
                <!-- fix popup register -->
                <div class="message login_error error_2 ms-error ms-default"><?php esc_html_e( 'The password is not correct.','decofurniture' ); ?></div>
                
            </div>
            <form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
                <?php do_action( 'woocommerce_register_form_start' ); ?>
                <div class="form-field">
                    <input placeholder="<?php esc_html_e('Username','decofurniture') ?>" type="text" name="user_login" id="user_loginr" class="input" value="" size="20" autocomplete="off"/>
                </div>
                <div class="form-field">
                    <input placeholder="<?php esc_html_e('Email','decofurniture') ?>" type="email" name="user_email" id="user_email" class="input" value="" size="25" autocomplete="off"/>
                </div>
                <?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ){ ?>
                    <div class="form-field">
                    	<!-- fix popup register -->
                        <input placeholder="<?php esc_html_e( 'Password', 'decofurniture' ); ?>" type="password" name="user_pass" id="reg_password" autocomplete="new-password" />
                    </div>
                <?php }?>
                <div class="extra-field">
                    <?php 
                ...
                <?php if ( 'no' != get_option( 'woocommerce_registration_generate_password' ) ){ ?>
                    <div id="reg_passmail">
                        <?php esc_html_e( 'Registration confirmation will be emailed to you.','decofurniture' ); ?>
                    </div>
                <?php }?>
                <div class="submit"><input type="submit" name="wp-submit" class="elth-bt-default elth-bt-full" value="<?php esc_attr_e('Register',"decofurniture"); ?>" /></div>
                <?php do_action( 'woocommerce_register_form_end' ); ?>
            </form>

            <div class="nav-form">
                <a href="#loginform" class="popup-redirect login-link"><?php esc_html_e( 'Log in','decofurniture' ); ?></a>
                <a href="#lostpasswordform" class="popup-redirect lostpass-link"><?php esc_html_e( 'Lost your password?','decofurniture' ); ?></a>
            </div>
        </div>
        <?php
	}
	public function lostpass_form($redirect_to = '') {
        ...
        <div class="elth-lostpass-form popup-form">
            <div class="form-header">
                <h2><?php esc_html_e( 'Reset password','decofurniture' ); ?></h2>
                <div class="desc"><?php esc_html_e( 'Recover your password','decofurniture' ); ?></div>
                <div class="message ms-default ms-done"><?php esc_html_e( 'Password reset email has been sent.','decofurniture' ); ?></div>
                <div class="message login_error ms-error ms-default"><?php esc_html_e( 'The email could not be sent.
Possible reason: your host may have disabled the mail function.','decofurniture' ); ?></div>
            </div>
            <form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
                <div class="form-field">
                    <input placeholder="<?php esc_html_e( 'Username or Email Address','decofurniture' ); ?>" type="text" name="user_login" id="user_loginlp" class="input" value="" size="20" autocomplete="off"/>
                </div>
                <div class="extra-field">
                    <?php do_action( 'lostpassword_form' ); ?>
                    <input type="hidden" name="redirect_to1" value="<?php echo esc_attr( $redirect_to ); ?>" />
                </div>
                <div class="submit"><input type="submit" name="wp-submit" class="elth-bt-default elth-bt-full" value="<?php esc_attr_e('Get New Password','decofurniture'); ?>" /></div>
                <div class="desc note"><?php esc_html_e( 'A password will be e-mailed to you.','decofurniture' ); ?></div>
            </form>
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elth-account-icon'		=> esc_html__( 'Icon', 'decofurniture' ),
				],
			]
		);
		...
		$this->add_control(
			'icon_logged',
			[
				'label' => esc_html__( 'Icon logged', 'decofurniture' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
					'value' => 'la la-user',
					'library' => 'solid',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Type your text to add search button', 'decofurniture' ),
			]
		);
		...
		$this->add_control(
			'account_bttext_pos',
			[
				'label' => esc_html__( 'Text position', 'decofurniture' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'after-icon',
				'options' => [
					'after-icon'   => esc_html__( 'After icon', 'decofurniture' ),
					'before-icon'  => esc_html__( 'Before icon', 'decofurniture' ),
				],
				'condition' => [
					'account_bttext!' => '',
					'icon[value]!' => '',
		...
		$this->start_controls_section(
			'section_links',
			[
				'label' => esc_html__( 'Links', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater_text->add_control(
			'roles',
			[
				'label' => esc_html__( 'Show with roles', 'decofurniture' ),
				'description' => esc_html__( 'Choose roles to show. Default is show with all roles', 'decofurniture' ),
		...
		$this->add_control(
			'list_links',
			[
				'label' => esc_html__( 'Add links', 'decofurniture' ),
		...
		$this->add_responsive_control(
			'wrap_links_left',
			[
				'label' => esc_html__( 'Wrap Left', 'decofurniture' ),
				'type' => Controls_Manager::CHOOSE,
				'default'	=> '',
				'options' => [
					'0' => [
						'title' => esc_html__( '0', 'decofurniture' ),
						'icon' => 'eicon-text-align-left',
					],
					'inherit' => [
						'title' => esc_html__( 'Inherit', 'decofurniture' ),
		...
		$this->add_responsive_control(
			'wrap_links_right',
			[
				'label' => esc_html__( 'Wrap Right', 'decofurniture' ),
				'type' => Controls_Manager::CHOOSE,
				'default'	=> '',
				'options' => [
					'0' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography button text', 'decofurniture' ),
