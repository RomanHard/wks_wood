...
class Th_Menu extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu', 'decofurniture' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
            'content_tab',
            [
                'label' => esc_html__('Menu settings', 'decofurniture'),
        ...
        $this->add_control(
            'nav_menu',
            [
                'label'     =>esc_html__( 'Select menu', 'decofurniture' ),
		...
		$this->add_control(
			'main_menu_style',
			[
				'label' => esc_html__( 'Menu style', 'decofurniture' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => esc_html__( 'Default', 'decofurniture' ),
					'icon' => esc_html__( 'Menu icon', 'decofurniture' ),
				],
			]
		);
        ...
        $this->add_responsive_control(
			'main_menu_position',
			[
				'label' => esc_html__( 'Menu position', 'decofurniture' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left'  => esc_html__( 'Left', 'decofurniture' ),
					'center' => esc_html__( 'Center', 'decofurniture' ),
                    'right' => esc_html__( 'Right', 'decofurniture' ),
                    'justified'  => esc_html__( 'Justified', 'decofurniture' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
            'content_side_tab',
            [
                'label' => esc_html__('Menu side/mobile', 'decofurniture'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
		);
		...
		$this->add_control(
			'th_nav_menu_logo',
			[
				'label' => esc_html__( 'Choose Mobile Menu Logo', 'decofurniture' ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Item text color', 'decofurniture' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Head Padding', 'decofurniture' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            'style_tab_menuitem',
            [
                'label' => esc_html__('Menu item style', 'decofurniture'),
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'decofurniture' ),
        ...
        $this->add_responsive_control(
			'menu_item_spacing',
			[
				'label' => esc_html__( 'Spacing', 'decofurniture' ),
                'type' => Controls_Manager::DIMENSIONS,
		...
		$this->start_controls_tabs(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background', 'decofurniture' ),
					'types' => ['classic', 'gradient'],
					'selector' => '{{WRAPPER}} .th-navbar-nav > li > a',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (Active)', 'decofurniture' ),
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Items Border', 'decofurniture' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Last Child', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border First Child', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu item style', 'decofurniture'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Submenu Indicator', 'decofurniture' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'th_line_arrow',
				'options' => [
					'th_line_arrow'  => esc_html__( 'Line Arrow', 'decofurniture' ),
					'th_plus_icon' => esc_html__( 'Plus', 'decofurniture' ),
					'th_fill_arrow' => esc_html__( 'Fill Arrow', 'decofurniture' ),
					'th_none' => esc_html__( 'None', 'decofurniture' ),
                ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator color', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'devices' => [ 'desktop', 'tablet' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator Margin', 'decofurniture' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (hover)', 'decofurniture' ),
					'type' => Controls_Manager::COLOR,
					'devices' => [ 'desktop', 'tablet' ],
					'selectors' => [
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background (hover)', 'decofurniture' ),
					'types' => [ 'classic', 'gradient' ],
					'selector' => '
			...
			$this->add_group_control(
				...
				[
					...
					'label' 	=> esc_html__( 'Item background (Active)', 'decofurniture' ),
					'types'		=> ['classic', 'gradient'],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sub Menu Items Border', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu panel style', 'decofurniture'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Panel Menu Border', 'decofurniture' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Container background', 'decofurniture' ),
                'types' => [ 'classic','gradient' ],
                'selector' => '{{WRAPPER}} .th-navbar-nav .sub-menu',
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container width', 'decofurniture' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon menu Style', 'decofurniture' ),
                'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Icon menu Toggle', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Position', 'decofurniture' ),
        ...
        $this->add_responsive_control(
			'menu_toggle_size',
			[
				'label' => esc_html__( 'Size', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Size height', 'decofurniture' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Humber Icon Color', 'decofurniture' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Close Toggle', 'decofurniture' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Menu Logo', 'decofurniture' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		if($settings['nav_menu'] != '' && wp_get_nav_menu_items($settings['nav_menu']) !== false){
			...
			if(isset($settings['th_nav_menu_logo']['url']) && !empty($settings['th_nav_menu_logo']['url'])){
				$logo_mobile = 	'<a class="mobile-logo" href="'.home_url('/').'">
									<img src="'.$settings['th_nav_menu_logo']['url'].'" alt="'.esc_attr__("logo mobile","decofurniture").'" >
								</a>';
			}
			...
			echo 	'<div class="th-menu-container th-menu-offcanvas-elements th-navbar-nav-default ' .$settings['style_tab_submenu_item_arrow'].' menu-style-'.$settings['main_menu_style'].'">
						'.$icon_html.'
