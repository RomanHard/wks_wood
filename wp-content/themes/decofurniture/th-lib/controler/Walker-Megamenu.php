	    ...
	    if(is_object($args)){
		    ...
		    if(!empty($image))  $item_output .= '<div class="preview-image">
	  		...
	  		if($mega_menu){
		    	...
		    	$content = str_replace('http'.'s://decofuniture.ththeme.net/', esc_url(home_url('/')), $content);
		    	$content = str_replace('http'.'://decofuniture.ththeme.net/', esc_url(home_url('/')), $content);
