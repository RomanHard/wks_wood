...
if($check_related == '1'):
    ...
    $title_df   = esc_html__("You might also like","decofurniture");
    $title 		= th_get_option('post_single_related_title',$title_df);
    $number 	= th_get_option('post_single_related_number','6');
    $size 		= th_get_option('post_single_related_size','380x255');
    ...
    <div class="th-block-detail single-related-post">
        ...
        $button_text = esc_html__("Read more", "decofurniture");
