<?php
if(!function_exists('s7up_admin_banner')){
	function s7up_admin_banner() {
		$ch = wp_remote_get("http://7uptheme.com/wordpress/verifycode/wp-json/get-content/banner");
...
add_action( 'admin_notices', 's7up_admin_banner',99 );
?>